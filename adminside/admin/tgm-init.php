...
add_action( 'tgmpa_register', 'sppro_required_plugins' );
/**
 ...
 */
function sppro_required_plugins() {
	/*
	...
	$config = array(
		...
		'menu'         => 'sppro_required', // Menu slug.
		'parent_slug'  => 'sppro_options',            // Parent menu slug.
		'capability'   => 'edit_theme_options',    // Capability needed to view plugin install page, should be a capability associated with the parent menu used.
		'has_notices'  => true,                    // Show admin notices or not.
		'dismissable'  => false,                    // If false, a user cannot dismiss the nag message.
		'dismiss_msg'  => 'Slick Popup Pro',                      // If 'dismissable' is false, this message will be output at top of nag.
